...
use delta_benchmarks::{
    ...
    merge_noop_heavy_upsert, merge_upsert, prepare_source_and_table, register_tpcds_tables,
    run_smoke_once, run_sort_bench_once, tpcds_queries, tpcds_query, MergeOp, MergePerfParams,
    MergeTestCase, SmokeParams, SortBenchMode, SortBenchParams, SortDataParams,
};
...
enum Command {
    ...
    SortBench {
        ...
        /// to all of baseline, declared, inferred
